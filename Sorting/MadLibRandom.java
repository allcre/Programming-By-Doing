...
public class MadLibRandom
{
	public static void main(String[] args)
	{
		...
		int ci   = 0 + (int)(Math.random()* colors.length      ); // color 1
    int ci2  = 0 + (int)(Math.random()* colors.length      ); // color 2
    ...
    int adv  = 0 + (int)(Math.random()* adverbs.length     ); // adverb
